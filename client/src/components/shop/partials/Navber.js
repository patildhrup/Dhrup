...
import { FaBars, FaUserCircle, FaBoxOpen, FaUser, FaSignOutAlt, FaMedkit } from "react-icons/fa";
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer flex items-center"
              onClick={(e) => history.push("/")}
            >
              <FaMedkit className="mr-2" /> View Organs
            </span>
            {/* <span
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-center text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center"
            >
              <MdHealthAndSafety className="text-green-600 text-3xl mr-2" />
              TransplantNet
            </span>
          </div>
          <div
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                <div
                  ...
                  title="Logout"
                >
                  <FaUserCircle className="cursor-pointer w-8 h-8 text-gray-600 hover:text-gray-800" />
                      ...
                      <Fragment>
                        <li className="flex flex-col text-gray-700 w-48 shadow-lg">
                          <span
                            ...
                            className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer items-center"
                          >
  ...
  />
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <span
              className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer flex items-center"
              onClick={(e) => history.push("/")}
            >
              <FaMedkit className="mr-2" /> View Organs
            </span>
            ...
            <span
              ...
              onClick={(e) => history.push("/contact-us")}
            >
              <MdHealthAndSafety className="mr-2" /> Contact us
            </span>
          </div>
        </div>
      </nav>
